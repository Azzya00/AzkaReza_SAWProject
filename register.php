...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO tbl_daftar (nama, username, password) VALUES ('$nama','$username','$password')");
        if ($insert) {
...
<body>
    ...
    <div class="card card-login">
        ...
        <form method="post">
            ...
            <span class="text-link"><a href="index.php">Sudah punya akun? Login</a></span>
        </form>
    </div>
